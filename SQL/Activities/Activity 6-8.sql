--To  Create a table for activity 6,7,8
create table orders(
...
--Activity 7 : Basic Aggregate operations
...
--Activity 8 : Aggregation Operation
...
SELECT customer_id, order_date,order_no, MAX(purchase_amount) FROM orders GROUP BY customer_id, order_date,order_no HAVING MAX(purchase_amount) IN(2030, 3450, 5760, 6000);
...
public class Activity5 {
  ...
  public void printHeaderUrl() {
   ...
   //  Assert.assertEquals(loginMessage ,"SUITECRM DASHBOARD");
     ...
     WebElement toolbar = driver.findElement(By.cssSelector(".desktop-toolbar"));
     String color = toolbar.getCssValue("color");
     System.out.println("The color of navigation bar :" +color);
